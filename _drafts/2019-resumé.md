...
- 5년-10년 뒤 어떤 개발자?
  - 지식을 공유하는 것을 즐기는 개발자가 되고 싶다. 그래서 일단 단기적인 목표로는 우아한형제들 기술블로그에 포스팅을 하나 하는 것을 가장 단기적인 목표로 삼을 것이다. 기술 중 하나만큼은 가장 잘한다 라는 기술을 하나 만들어서 그 기술에 대한 전문가는 누구지? 라는 질문에 제일 먼저 이름이 언급되는 개발자가 되었으면 좋겠다. 그 다음으로는 KSUG나 블로그, 유튜브등을 통해서 내 지식을 공유하고 모든 사람들이 쉽게 나의 경험을 전달 받을 수 있도록 할 수 있었으면 좋겠다.
