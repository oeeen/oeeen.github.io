...
- 우형에서 어떤 서비스를 하고 싶냐
  - 배민 상회나, 새로 이름을 바꾼 B마트와 같은 이커머스 서비스를 해보고 싶다. 배민 상회는 자영업 하시는 분들에게 신경써야 할 점이 엄청나게 많은데, 그 신경써야 할 부분을 조금이라도 덜어주려는 우형의 노력을 도와 음식점 사장님들이 음식에만 집중하도록 만들고 싶다. 우형에서 만드는 이커머스 서비스는 일반적인 이커머스와는 달리 타겟이 사장님들 대상인 배민 상회여서 배달의 민족으로 다져진 탄탄한 고객층이 있다. 각 사장님들의 주문 건 수에 따라 그에 맞는 수량으로 주문 할 수 있도록 데이터를 분석하는 작업도 필요할 것 같고, 재미있을 것 같다. B마트의 경우엔 작년 말에 서비스를 시작해서 점점 확장해가는 서비스 인걸로 알고 있다. 확장하고 성장해나가는 서비스를 함께 어려움을 겪으면서 성장해 나가는 것으로 프로젝트, 또는 서비스의 성장을 겪으며 저의 성장을 더욱 더 체감하면서 다니고 싶다. 서비스가 점차 커지면서 겪을 수 있는 문제들을 직접적으로 경험하며 이 문제를 해결하면서 성장하고 싶다.
...
- 떨어지면 어디 쓸거냐
  - 좋은 동료, 믿을 수 있는 동료, 본인이 다루는 도메인을 정확히 설명할 수 있는 동료, 본인의 코드를 논리적으로 설명할 수 있는 동료들이 있는 곳이면 좋겠다. 성장 가능성이 있는 회사, 내가 성장함을 느낄 수 있는 회사 였으면 좋겠다. 그래서 네이버 파이낸셜이나 카카오페이, 토스와 같은 결제 관련된 회사에 지원할 예정이다. 이미 탄탄한 플랫폼과 고객층을 가지고 있기 때문에 내가 성장할 수 있을 대규모 트래픽을 경험할 수 있을 것 같고, 데이터에 대한 경험도 할 수 있을 것 같다. 일단은 네이버 파이낸셜, 카카오페이와 같은 결제시스템 쪽으로 가서 조금 더 신중하고, 사고쳤을 때 크리티컬한 문제가 터지는 경험을 해보고 싶다. 해당 회사들도 코드리뷰도 한다고 들었고, 좋은 선배 개발자들이 있는 것으로 알고 있어서 그 회사에서 성장할 수 있을 것 같다.
- 기술적인 이슈를 해결했던 경험 이야기해달라
  - 프로젝트 했을 때, 배포 자동화 및 무중단 배포를 구현하려고 했는데 머리속으로는 어떤 방식인지 알았지만 실제로 해본 적이 없어서 시간적으로 어려움이 많았습니다. 그래도 일단 애플리케이션 다중화를 도커 컨테이너 기반으로 했고, 도커 컴포즈 활용해서 무중단 배포까지 구현했다. 블로그에 정리도 해놨다.
...
- 자소서 기반 질문 하나
  ...
  - 또 하나 말해보자면?
    ...
    - 항상 회고하고 반성하는 것: 잘못 된 점은 없는지 항상 되짚어보는 것.
- 위의 이야기에서 본인의 강점 단점
  - 장점: 좋아하는 일을 할 때 웃으면서 일할 수 있다. 테크코스 하면서 주변 크루들에게 받았던 피드백은, 본인이 어떤 의견을 말했을때나 모르는 내용을 던졌을 때 제가 먼저 해보죠? 하면서 코드를 살펴본다거나 실제로 구현해보면서 결과를 확인하려는 노력이 좋았다고 했다. 지금은 배우는 단계기 때문에 일단 해보는 것도 충분히 학습차원에도 많은 도움이 된다고 생각해서 그렇게 행동했다. 긍정적인 에너지를 많이 받았다고 한다.
...
- 5년-10년 뒤 어떤 개발자?
  - 지식을 공유하는 것을 즐기는 개발자가 되고 싶다. 그래서 일단 단기적인 목표로는 우아한형제들 기술블로그에 포스팅을 하나 하는 것을 가장 단기적인 목표로 삼을 것이다. 기술 중 하나만큼은 가장 잘한다 라는 기술을 하나 만들어서 그 기술에 대한 전문가는 누구지? 라는 질문에 제일 먼저 이름이 언급되는 개발자가 되었으면 좋겠다. 그리고 지식이 뛰어나더라도 세미나를 하거나 공유하는 것을 못하는 개발자가 아닌 KSUG나 블로그, 유튜브등을 통해서 내 지식을 공유하고 모든 사람들이 쉽게 나의 경험을 전달 받을 수 있도록 할 수 있었으면 좋겠다.
